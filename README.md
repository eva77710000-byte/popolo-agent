...
* **Milestone 3: 코드 안정화 및 모듈화 (진행 중)**
    * [ ] 모듈화를 통한 코드 아키텍처 개선
    * [ ] 통합 분석 파이프라인 최적화
* **Milestone 4: 배포 자동화 및 운영 최적화**
    * [ ] Docker 컨테이너화 및 서버 배포
    * [ ] GitHub Actions 기반 CI/CD 자동화 구축
    * [ ] 시스템 로깅 및 모니터링 체계 도입
    * [ ] 토큰 사용량(Token Usage) 분석 및 비용 최적화
* **Milestone 5: 서비스 고도화 및 사용자 경험 확장**
    * [ ] Slack 대화형 커리어 매니저 확장
    * [ ] 기술 서사 생성 품질 고도화
